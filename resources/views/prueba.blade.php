...
<header class="header">
	...
	<nav class="main-menu">
		<div class="content">
			<div class="logo">
				<div class="edit-logo">
					<a href="INICIO.html" title="Logo oficial de Papus Club">
			...
			<nav class="menu" id="menu">
				<ul>
					<li><a href="#">PAPUS CLUB<span class="despliegue">▼</span></a>
						<ul>
							<li><a href="historia-papusclub.html" title="A cerca del club" target="_self">Acerca del Club</a></li>
					...
					<li><a href="#">SEDES<span class="despliegue">▼</span></a>
						<ul>
							<li><a href="SEDE-CALLAO.html" title="Callao" target="_self">Callao<span class="despliegue">▼</span></a>
								<ul>
									<li><a href="#" title="Concesiones" target="_self">Concesiones</a></li>
									<li><a href="#" title="Servicios" target="_self">Servicios</a></li>
									<li><a href="reserva-bungalow.html" title="Bungalows" target="_self">Bungalows</a></li>
								</ul>
							</li>
					...
					<li><a href="#">ACTIVIDADES<span class="despliegue">▼</span></a>
						<ul>
							<li><a href="#" title="ir a cursos" target="_self">Cursos<span class="despliegue">▼</span></a>
								<ul>
									<li><a href="#" title="ir a futbol" target="_self">Futbol</a></li>
...
<main class="main">
	...
	<div class="container" id="ruta-navegacion">
		<br/>
		<div class="row">
			<a class="btn btn-link text-left withoutpadding" href="INICIO.html">INICIO <span class="glyphicon glyphicon-chevron-right"></span></a>
			...
			<button class="btn btn-link text-left withoutpadding" href="#">CURSOS DEPORTIVOS <span class="glyphicon glyphicon-chevron-right"></span></button>
			<label class="text-left withoutpadding">FULBITO</button></label>
		</div>
		<br/>
		</div>
	</div>
