		...
		<table class="table table-bordered table-hover text-center display" id="example">
			<thead class="active">
				...
				<tbody>
					...
					@if($bloqueado)
					<td>
						<a class="btn btn-info disabled" href="{{url('/reservar-ambiente/'.$ambiente->id.'/'.$fechaIniValue.'/'.$fechaFinValue.'/searchSocio-otros-ambientes-adminR/')}}"  title="Detalle" ><i class="glyphicon glyphicon-ok"></i></a>
			        </td>
			        @else
					<td>
