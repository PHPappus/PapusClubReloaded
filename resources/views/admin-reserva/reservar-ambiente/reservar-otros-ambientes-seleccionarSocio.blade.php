...
=======
							        			<a class="btn btn-info" href="{{url('/reservar-ambiente/'.$ambiente->id.'/'.$socio->id.'/new-reserva-otro-ambiente-adminR')}}"  title="Detalle" ><i class="glyphicon glyphicon-ok"></i></a>
>>>>>>> 6142a4c7147fe19efa4cd28a24db990e10bd63ee
							       			</td>
							            </tr>				            		
									@endforeach
