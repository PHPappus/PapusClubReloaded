	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-left">
				<br/><br/>
				<p class="lead"><strong>RESERVAS DE AMBIENTES</strong></p>
				<br/>
			</div>
			...
			<table class="table table-bordered table-hover text-center display" id="example">
					<thead class="active">
						<tr>
							...
							<th><DIV ALIGN=center>HORA FIN</th>
							...
							@foreach($reservas as $reserva)						
						    	@if($reserva->ambiente->tipo_ambiente != 'Bungalow')						
							    	<tr>
								        ...
								        <td>
								        <a class="btn btn-info"  title="Cancelar" data-href="{{url('/reservar-ambiente/'.$reserva->id.'/deleteOtrosAdminR')}}" data-toggle="modal" data-target="#modalEliminar"><i class="glyphicon glyphicon-remove"></i></a> 
								        </td>
