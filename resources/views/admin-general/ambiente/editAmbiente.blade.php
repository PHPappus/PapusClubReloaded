					...
					<tbody>
							@foreach ($tarifas as $tarifa)		
						    	<tr>
									...
									<td align="center"> 
										<div align="center">
								      		<input type="text" style="text-align:center;" onkeypress="return inputLimiter(event,'Numbers')"   class="form-control" id="{{$tarifa->tipo_persona->descripcion}}Input" name="{{$tarifa->tipo_persona->descripcion}}" value="{{$tarifa->precio}}" placeholder="Monto" >
								    	</div>
								</td>							        
								</tr>
							@endforeach
