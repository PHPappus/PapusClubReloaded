	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-left">
				<p class="lead"><strong>REGISTRAR INVITADO</strong></p>
			</div>
		</div>	
	</div>

	<div class="container">
		<form method="POST" action="/Socio/{{$socio->id}}/invitado/save" class="form-horizontal form-border">
						...
						<div role="tabpanel" class="tab-pane active" id="seccion1">
							<form action="" class="form-horizontal form-border">
								...
								<div class="form-group required" >
										...
										<div class="btn-group">
											<a href="/Socio/{{$socio->id}}/editar" class="btn btn-info">Cancelar</a>
										</div>
								</div>																
							</form>
						</div>
