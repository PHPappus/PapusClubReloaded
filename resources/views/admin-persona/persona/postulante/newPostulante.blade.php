								...
								<form action="" class="form-horizontal form-border">
									...
									<div class="form-group required">
										<div class="col-sm-6">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" id="nombre" name="nombre" onkeypress="return inputLimiter(event,'NameCharacters')" placeholder="Nombre" style="max-width: 250px" value="{{old('nombre')}}" >
											</div>	
										</div>
									</div>
									...
									<div class="form-group required">
										<div class="col-sm-6">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" id="ap_paterno" name="ap_paterno" onkeypress="return inputLimiter(event,'NameCharacters')" placeholder="Apellido Paterno" style="max-width: 250px" value="{{old('ap_paterno')}}">
											</div>	
										</div>
									</div>
									...
									<div class="form-group required">
										<div class="col-sm-6">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" id="ap_materno" name="ap_materno" onkeypress="return inputLimiter(event,'NameCharacters')" placeholder="Apellido Materno" style="max-width: 250px" value="{{old('ap_materno')}}">
											</div>	
										</div>
									</div>
