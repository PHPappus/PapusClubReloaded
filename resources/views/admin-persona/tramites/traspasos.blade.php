						...
						<tbody>
							@foreach($traspasos as $traspaso)						
								<tr>
									...
									<td>{{$traspaso->nombre}}</td>
					            	<td>
					              	<a class="btn btn-info" href="#" title="Aceptar" data-href="{{url('/traspaso/'.$traspaso->id.'/aceptar')}}" data-toggle="modal" data-target="#modalEliminar"><i class="glyphicon glyphicon-remove"></i></a>
					            	</td>
					            	<td>
