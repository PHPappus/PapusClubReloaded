					...
					@if(Session::get('resultado')=='aceptar')
						<div class="col-sm-6" id="printArea">
							...
							<p class="lead col-sm-6 text-center"><strong>! BIENVENIDO ¡</strong></p>
	  						<textarea id ="descripcion"  class="form-control" name="descripcion"  placeholder="Descripción"  rows="5" cols="50" style="max-width: 850px; max-height: 300px;" readonly>{{retornar_mensaje_socio($socio,$sede->nombre,$numFam,$numInv,$precio_tot,$fecha_2)}}</textarea>
						</div>
				</div>
			</div>
			<br><br>
