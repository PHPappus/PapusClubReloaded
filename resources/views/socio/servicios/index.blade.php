					...
					{{$sxs->idservicio}}					
						@foreach($servicios as $servicio)
							...
							<tr>
								...
								<td>
							        <a class="btn btn-info" href="" title="agregarservicio" ><i class="glyphicon glyphicon-ok"></i></a>
							    </td> 
							</tr>
							@endif
						@endforeach 
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 text-right">
					<!--p>{!!URL::to('/talleres/mis-inscripciones')!!}</p-->
						<a href="" title="Ver mis inscripciones" class="btn btn-lg btn-primary" >Mis Inscripciones</a>		
					</div>
