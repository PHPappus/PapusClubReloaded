	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-left">				
				<p class="lead"><strong>CONCESIONARIAS</strong></p>
				<br/>
			</div>
			...
			<table class="table table-bordered table-hover text-center display" id="example">
					...
					<tbody>
						...
						<tr>
							...
							<td>
				              	<a class="btn btn-info" href="{{url('/concesionaria/'.$concesionaria->id.'')}}" title="Editar" ><i class="glyphicon glyphicon-pencil"></i></a>
				            </td>
				            <td>
				              	<a class="btn btn-info"  title="Eliminar" data-href="{{url('/concesionaria/'.$concesionaria->id.'/delete')}}" data-toggle="modal" data-target="#modalEliminar"><i class="glyphicon glyphicon-remove"></i></a>             
				            </td>
				        </tr>
			        	@endforeach    
					</tbody>						
	...
	<div class="container">		
		<div class="form-group">
			<div class="col-sm-16 text-right">
				<a class="btn btn-info" href="{{url('/concesionaria/new')}}" title="Registrar Concesionaria" >Registrar Concesionaria<i class="glyphicon" ></i> </a>	
			</div>
		</div>
		<br/>
	</div>
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <p>¿Está seguro que desea eliminar la concesionaria?</p>
	      </div>
