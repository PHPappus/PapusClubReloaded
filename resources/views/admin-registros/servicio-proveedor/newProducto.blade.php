...
<main class="main">
	<div class="content" style="max-width: 100%;">
		...
		<div class="container">
			<form method="POST" action="/servicioProveedor/new/servicioProveedor" class="form-horizontal form-border">
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
				...
				<div class="form-group required">
			    	...
			    	<div class="col-sm-5">			      		
			      		<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del Servicio" value="{{old('nombre')}}">
			    	</div>
			  	</div>			  	
				...
				<div hidden class="form-group required">
			  	...
			  	<div class="form-group required" hidden>
			    	...
			    	<div class="col-sm-5">			      		
			      		<input type="text" class="form-control" id="tipo_producto" name="tipo_producto" placeholder="Tipo de Producto"  value="Servicio">
			    	</div>
			  	</div>		
			  	...
			  	<div class="form-group required" hidden>
			    	...
			    	<div class="col-sm-5">			      		
			      		<input type="text" class="form-control" onkeypress="return inputLimiter(event,'DoubleFormat')"  id="precio" name="precio" placeholder="Precio"  value="0">
			    	</div>
			  	</div>	  
