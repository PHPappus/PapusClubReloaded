...
class InscriptionActividadController extends Controller
{
    ...
    public function inscriptionActividad()
    {
        try {
            ...
            $error = 'inscriptionActividad-InscriptionActividadController';
    ...
    public function storeInscriptionActividad($id)
    {
        try {
            ...
            $error = 'storeInscriptionActividad-InscriptionActividadController';
            return view('errors.corrigeme', compact('error'));
        }
    }
    public function storeInscriptionActividadtoFamiliar($id)
    {
        try {
           ...
           /* $personas = Persona::where('id_usuario','=',null)->where('id_tipo_persona','=',1)//Trabajador
            ...
            $error = 'storeInscriptionActividadtoFamiliar-InscriptionActividadController';
            return view('errors.corrigeme', compact('error'));
        }
    }
    ...
    public function filterActividades(Request $request)
    {
        try {    
            ...
            $error = 'filterActividades-InscriptionActividadController';
            return view('errors.corrigeme', compact('error'));
        }
    }
    ...
    public function show($id){
        try {
            ...
            $error = 'show-InscriptionActividadController';
            return view('errors.corrigeme', compact('error'));
        }
    }
    public function misinscripciones()
    {
        try {
            ...
            $error = 'misinscripciones-InscriptionActividadController';
            return view('errors.corrigeme', compact('error'));
        }
    }
