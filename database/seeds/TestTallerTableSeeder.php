...
class TestTallerTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Taller::insert(['reserva_id'					=> 1,
			        	...
			        	'profesor'						=> 'Pelotudo',
			        	'fecha_inicio_inscripciones' 	=> Carbon::create(2016,6,23)->toDateString(), 
        ...
        Taller::insert(['reserva_id'					=> 1,
			        	...
			        	'profesor'						=> 'Jugadorazo',
			        	'fecha_inicio_inscripciones' 	=> Carbon::create(2016,6,24)->toDateString(), 
			        	'fecha_fin_inscripciones'    	=> Carbon::create(2016,7,01)->toDateString(), 
			        	'fecha_inicio' 					=> Carbon::create(2016,7,02)->toDateString(), 
        ...
        Taller::insert(['reserva_id'					=> 1,
			        	...
			        	'profesor'						=> 'Pinturesco',
			        	'fecha_inicio_inscripciones' 	=> Carbon::create(2016,6,22)->toDateString(), 
			        	'fecha_fin_inscripciones'    	=> Carbon::create(2016,6,26)->toDateString(), 
