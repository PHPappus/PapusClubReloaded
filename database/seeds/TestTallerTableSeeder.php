...
class TestTallerTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Taller::insert(['reserva_id'					=> 1,
			        	...
			        	'profesor'						=> 'Pelotudo',
			        	'fecha_inicio_inscripciones' 	=> Carbon::create(2016,6,10)->toDateString(), 
			        	'fecha_fin_inscripciones'    	=> Carbon::create(2016,6,24)->toDateString(), 
			        	'fecha_inicio' 					=> Carbon::create(2016,7,1)->toDateString(), 
        ...
        Taller::insert(['reserva_id'					=> 1,
			        	...
			        	'profesor'						=> 'Jugadorazo',
			        	'fecha_inicio_inscripciones' 	=> Carbon::create(2016,6,8)->toDateString(), 
			        	'fecha_fin_inscripciones'    	=> Carbon::create(2016,6,22)->toDateString(), 
			        	'fecha_inicio' 					=> Carbon::create(2016,6,28)->toDateString(), 
			        	'fecha_fin' 					=> Carbon::create(2016,7,28)->toDateString(), 
        ...
        Taller::insert(['reserva_id'					=> 1,
			        	...
			        	'profesor'						=> 'Pinturesco',
			        	'fecha_inicio_inscripciones' 	=> Carbon::create(2016,6,16)->toDateString(), 
			        	'fecha_fin_inscripciones'    	=> Carbon::create(2016,6,22)->toDateString(), 
			        	'fecha_inicio' 					=> Carbon::create(2016,7,01)->toDateString(), 
			        	'fecha_fin' 					=> Carbon::create(2016,7,15)->toDateString(), 
			        	'cantidad_sesiones' 			=> 4,
			        	'vacantes' 						=> 10,
        ]);
    }
